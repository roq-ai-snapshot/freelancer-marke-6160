  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Freelancer Marketplace - Your one-stop destination to connect, collaborate and create incredible projects with talented freelancers worldwide."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Freelancer Marketplace - Your one-stop destination to connect, collaborate and create incredible projects with talented freelancers worldwide.`}
            </Text>
            <Box
